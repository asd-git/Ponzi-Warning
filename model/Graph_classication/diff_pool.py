...
class DiffPool(torch.nn.Module):
    def __init__(self, in_channels, hidden, out_channels,num_layers, num_nodes,ratio=0.25):
        super().__init__()

        num_nodes = ceil(ratio * num_nodes)
        self.embed_block1 = Block(in_channels, hidden, hidden)
        self.pool_block1 = Block(in_channels, hidden, num_nodes)
